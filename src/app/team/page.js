              ...
              <Reveal key={f.name} delay={i * 100}>
                <div className="card-lift flex h-full flex-col rounded-3xl border border-neutral-200 bg-neutral-50 p-8 sm:p-10">
                  <div className="flex items-center gap-4">
                    <span className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#f26b1d] to-[#c2410c] text-xl font-black text-white shadow-[0_10px_24px_-8px_rgba(194,65,12,0.6)]">
                      {initials(f.name)}
                    </span>
                    <div>
